...
module sseg (
    ...
    always @(*) begin
        ...
        case (FirstFour)
            4'b0000:          led1_seg =  7'b0000001; // Display 0
            4'b0001, 4'b1111: led1_seg =  7'b1001111; // Display 1
            4'b0010, 4'b1110: led1_seg =  7'b0010010; // Display 2
